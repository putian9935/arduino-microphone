...
<style>
  .bg {height:100vh; overflow-y: hidden; background-position: center; background-repeat: no-repeat; background-size: cover; position: relative;
  ...
  body {font-family: sans-serif; text-align: center; color: white;}
...
uint8_t const wav_format_header[] = {
    82, 73, 70, 70, 36, 226, 4,   0,  87,  65,  86, 69,  102, 109, 116,
    32, 16, 0,  0,  0,  1,   0,   1,  0,   128, 62, 0,   0,   0,   125,
    0,  0,  2,  0,  16, 0,   100, 97, 116, 97,  0,  226, 4,   0,
};
